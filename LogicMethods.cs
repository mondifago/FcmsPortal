...
public static class LogicMethods
{
    ...
    //Add student to Learning path
    public static void AddStudentToLearningPath(LearningPath learningPath, Student student)
    {
        if (learningPath == null)
        {
            throw new ArgumentNullException(nameof(learningPath), "Learning path cannot be null.");
        ...
        if (learningPath.Students.Any(s => s.Id == student.Id))
        {
            throw new ArgumentException($"Student with Id {student.Id} is already enrolled in the learning path.");
        }
        learningPath.Students.Add(student);
        SetStudentFeesForLearningPath(learningPath);
    }

    //Add multiple students to a learning path
    public static void AddMultipleStudentsToLearningPath(LearningPath learningPath, List<Student> studentsToAdd)
    {
        if (learningPath == null)
        {
            throw new ArgumentNullException(nameof(learningPath), "Learning path cannot be null.");
